...
const de = {
  ...
  liveWindow: "LIVE-FENSTER",
  liveGenerated: "Aus Live-Daten · keine Kamera",
  ...
  momentSunriseFocusTitle: "Das erste Licht ist unterwegs.",
  momentSunriseFocusDetail: "In {place} beginnt der nächste Sonnenaufgang um {time} Uhr.",
  momentSunsetTitle: "Der Tag wird gleich leiser.",
  momentSunsetDetail: "In {place} geht die Sonne um {time} Uhr unter.",
  momentSunsetFocusTitle: "Das Abendlicht ist unterwegs.",
  momentSunsetFocusDetail: "In {place} beginnt der nächste Sonnenuntergang um {time} Uhr.",
  momentNightFocusTitle: "Die Nachtseite ist jetzt offen.",
  momentNightFocusDetail: "In {place} ist es gerade {time} Uhr.",
  ...
  whyNextSunrise: "Ausgewählt für den nächsten Sonnenaufgang in {place} um {time} Uhr.",
  whyNextSunset: "Ausgewählt für den nächsten Sonnenuntergang in {place} um {time} Uhr.",
  whySunriseFocus: "Ausgewählt, weil in {place} das nächste Morgenlicht wartet.",
  whySunsetFocus: "Ausgewählt, weil in {place} das nächste Abendlicht wartet.",
  whyNightFocus: "Ausgewählt, weil in {place} gerade die Nachtseite der Erde liegt.",
} as const;
...
const en: Record<MessageKey, string> = {
  ...
  liveGenerated: "From live data · no camera",
  ...
  momentSunriseFocusTitle: "The first light is on its way.",
  momentSunriseFocusDetail: "The next sunrise begins in {place} at {time}.",
  momentSunsetTitle: "The day is about to grow quieter.",
  momentSunsetDetail: "The sun sets in {place} at {time}.",
  momentSunsetFocusTitle: "The evening light is on its way.",
  momentSunsetFocusDetail: "The next sunset begins in {place} at {time}.",
  momentNightFocusTitle: "The night side is open now.",
  momentNightFocusDetail: "It is {time} in {place} right now.",
  ...
  whyNextSunrise: "Selected for the next sunrise in {place} at {time}.",
  whyNextSunset: "Selected for the next sunset in {place} at {time}.",
  whySunriseFocus: "Selected because the next morning light is waiting in {place}.",
  whySunsetFocus: "Selected because the next evening light is waiting in {place}.",
  whyNightFocus: "Selected because {place} is on the night side of Earth right now.",
};
