...
const de = {
  ...
  focusLegend: "Was möchtest du gerade sehen?",
  focusSurprise: "Überrasch mich",
  focusSunrise: "Morgenlicht",
  focusSunset: "Abendlicht",
  focusNight: "Nachtseite",
  travel: "Nächsten Moment entdecken",
  travelSunrise: "Dem Morgenlicht folgen",
  travelSunset: "Dem Abendlicht folgen",
  travelNight: "Nachtblick finden",
  travelSunriseContinue: "Weiter dem Morgenlicht folgen",
  travelSunsetContinue: "Weiter dem Abendlicht folgen",
  share: "Moment teilen",
  ...
  lightRouteKicker: "Dem Licht folgen",
  lightRouteReady: "Wähle eine Lichtspur und reise mit ihr weiter.",
  lightRouteFree: "Freie Reise · jeder Klick sucht einen neuen besonderen Übergang.",
  lightRouteSunrise: "Morgenlicht-Spur · Etappe {step} bei {place} um {time} Uhr.",
  lightRouteSunset: "Abendlicht-Spur · Etappe {step} bei {place} um {time} Uhr.",
  lightRouteNight: "Nachtspur · Etappe {step} auf der dunklen Seite bei {place}.",
  ...
  liveWindow: "LIVE-DATENSZENE",
  liveGenerated: "Ortszeit · Sonne · Wettermodell",
  viewSwitcherLabel: "Ansicht wählen",
  viewData: "Datenszene",
  viewSatellite: "Satellit",
  viewWebcam: "Webcam",
  signalCloud: "Wolken",
  signalWind: "Wind",
  signalVisibility: "Sicht",
  signalUnknown: "lokal",
  signalCloudValue: "{value} %",
  signalWindValue: "{speed} km/h · {direction}",
  signalVisibilityValue: "{distance} km",
  satelliteKicker: "Optionaler Satellitenblick",
  satelliteTitle: "Erde aus dem All",
  satelliteLoading: "NASA-Aufnahme wird erst jetzt geladen …",
  satelliteNearRealTime: "Nahe-Echtzeit, nicht live. Die Aufnahme kann Wolken oder Datenlücken enthalten.",
  satelliteLoaded: "NASA GIBS · Aufnahme vom {date}. Nahe-Echtzeit, nicht live.",
  satelliteError: "Die Satellitenaufnahme ist gerade nicht verfügbar. Die Datenszene bleibt erhalten.",
  satelliteSource: "In NASA Worldview öffnen",
  satelliteImageAlt: "NASA-Satellitenaufnahme der Region um {place} vom {date}",
  webcamKicker: "Seltenes Kamera-Extra",
  webcamTitle: "Geprüfte Ortskamera",
  webcamNotice: "Der Windy-Player wurde erst nach deiner Aktion verbunden.",
  webcamUnavailable: "Für diesen Ort ist keine geprüfte Kamera hinterlegt.",
  webcamWindyLink: "Webcam bei Windy öffnen",
  webcamOperatorLink: "Betreiberseite",
  webcamFrameTitle: "Webcam {title} im Windy-Player",
  ...
  aboutExternalMedia: "NASA-Bilder und seltene Webcams werden nur nach deiner ausdrücklichen Aktion geladen.",
  ...
  sourceSatellite: "Satellitenbilder: NASA GIBS · Quellenhinweis in der Ansicht",
  sourceWebcams: "Webcams: Windy-Embed · Betreiberhinweis in der Ansicht",
  ...
  momentSunriseFocusTitle: "Morgenlicht kommt.",
  momentSunriseFocusDetail: "Sonnenaufgang in {place}: {time} Uhr.",
  momentSunsetTitle: "Der Tag wird gleich leiser.",
  momentSunsetDetail: "In {place} geht die Sonne um {time} Uhr unter.",
  momentSunsetFocusTitle: "Abendlicht kommt.",
  momentSunsetFocusDetail: "Sonnenuntergang in {place}: {time} Uhr.",
  momentNightFocusTitle: "Die Nachtseite.",
  momentNightFocusDetail: "In {place}: {time} Uhr.",
  ...
  whyNextSunrise: "Nächstes Morgenlicht: {place}, {time} Uhr.",
  whyNextSunset: "Nächstes Abendlicht: {place}, {time} Uhr.",
  whySunriseFocus: "Gewählt für Morgenlicht in {place}.",
  whySunsetFocus: "Gewählt für Abendlicht in {place}.",
  whyNightFocus: "Gewählt für die Nachtseite in {place}.",
} as const;
...
const en: Record<MessageKey, string> = {
  ...
  focusLegend: "What would you like to see right now?",
  focusSurprise: "Surprise me",
  focusSunrise: "Morning light",
  focusSunset: "Evening light",
  focusNight: "Night side",
  travel: "Discover another moment",
  travelSunrise: "Follow the morning light",
  travelSunset: "Follow the evening light",
  travelNight: "Find a night view",
  travelSunriseContinue: "Keep following the morning light",
  travelSunsetContinue: "Keep following the evening light",
  share: "Share moment",
  ...
  lightRouteKicker: "Follow the light",
  lightRouteReady: "Choose a trail of light and keep travelling with it.",
  lightRouteFree: "Free journey · every click looks for another distinctive transition.",
  lightRouteSunrise: "Morning-light trail · stage {step} at {place}, {time}.",
  lightRouteSunset: "Evening-light trail · stage {step} at {place}, {time}.",
  lightRouteNight: "Night trail · stage {step} on the dark side at {place}.",
  ...
  liveWindow: "LIVE DATA SCENE",
  liveGenerated: "Local time · sun · weather model",
  viewSwitcherLabel: "Choose view",
  viewData: "Data scene",
  ...
  signalWindValue: "{speed} km/h · {direction}",
  signalVisibilityValue: "{distance} km",
  satelliteKicker: "Optional satellite view",
  satelliteTitle: "Earth from above",
  satelliteLoading: "The NASA image is only being loaded now …",
  satelliteNearRealTime: "Near real-time, not live. The image may contain clouds or data gaps.",
  satelliteLoaded: "NASA GIBS · image from {date}. Near real-time, not live.",
  satelliteError: "The satellite image is unavailable right now. The data scene remains available.",
  satelliteSource: "Open in NASA Worldview",
  satelliteImageAlt: "NASA satellite image of the region around {place} from {date}",
  webcamKicker: "Rare camera extra",
  webcamTitle: "Checked local webcam",
  webcamNotice: "The Windy player was connected only after your action.",
  webcamUnavailable: "No checked webcam is registered for this place.",
  webcamWindyLink: "Open webcam on Windy",
  webcamOperatorLink: "Operator website",
  webcamFrameTitle: "Webcam {title} in the Windy player",
  ...
  aboutExternalMedia: "NASA images and rare webcams load only after your explicit action.",
  ...
  sourceSatellite: "Satellite imagery: NASA GIBS · source notice in the view",
  sourceWebcams: "Webcams: Windy embed · operator notice in the view",
  ...
  momentSunriseFocusTitle: "Morning light is coming.",
  momentSunriseFocusDetail: "Sunrise in {place}: {time}.",
  momentSunsetTitle: "The day is about to grow quieter.",
  momentSunsetDetail: "The sun sets in {place} at {time}.",
  momentSunsetFocusTitle: "Evening light is coming.",
  momentSunsetFocusDetail: "Sunset in {place}: {time}.",
  momentNightFocusTitle: "The night side.",
  momentNightFocusDetail: "In {place}: {time}.",
  ...
  whyNextSunrise: "Next morning light: {place}, {time}.",
  whyNextSunset: "Next evening light: {place}, {time}.",
  whySunriseFocus: "Chosen for morning light in {place}.",
  whySunsetFocus: "Chosen for evening light in {place}.",
  whyNightFocus: "Chosen for the night side in {place}.",
};
