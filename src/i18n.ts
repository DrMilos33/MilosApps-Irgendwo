...
const de = {
  ...
  metaDescription:
    "Ein atmosphärisches Fenster zu einem realen Moment irgendwo auf der Erde – aus Ortszeit, Tageslicht und Wetter.",
  appTitle: "Irgendwo ist gerade …",
  menuRegion: "Moment wählen",
  heroLineOne: "Gerade jetzt",
  heroLineAccent: "irgendwo",
  heroLineThree: "auf der Erde.",
  productPromise: "Entdecke den Moment.",
  ...
  focusLegend: "Wohin als Nächstes?",
  focusSurprise: "Überrasch mich",
  focusSunrise: "Morgenlicht",
  focusSunset: "Abendlicht",
  focusNight: "Nachtseite",
  travel: "Moment finden",
  travelSunrise: "Morgenlicht finden",
  travelSunset: "Abendlicht finden",
  ...
  sceneInitial: "Atmosphärisches Foto und aktuelle Ortsdaten",
  sceneTraveling: "Unterwegs",
  liveWindow: "MOMENT-FENSTER",
  photoLiveData: "LIVE-DATEN",
  photoBoundary: "ATMOSPHÄRENFOTO · NICHT LIVE",
  photoKicker: "Atmosphärische Aufnahme",
  photoRepresentative: "Dieses Foto zeigt die Lichtstimmung, nicht den ausgewählten Ort.",
  photoBy: "Foto: {author}",
  photoSceneLabel: "Aktueller Moment in {place}: {title}. Atmosphärenfoto: {photo}.",
  ...
  aboutBody:
    "Die App verbindet eine kuratierte Ortsauswahl mit Ortszeit, Sonnenstand, Wetter und einem passend gewählten atmosphärischen Foto. Das Foto steht für die Lichtstimmung und wird nicht als Livebild des Orts ausgegeben.",
  ...
  aboutPhotos: "Die Fotos liegen lokal in der App und sind mit Quelle und Lizenz gekennzeichnet.",
  ...
  sourcePhotos: "Fotos: Wikimedia Commons · Einzellizenz am Motiv",
...
const en: Record<MessageKey, string> = {
  ...
  metaDescription:
    "An atmospheric window into a real moment somewhere on Earth – shaped by local time, daylight and weather.",
  appTitle: "Somewhere, right now …",
  menuRegion: "Choose a moment",
  heroLineOne: "Right now",
  heroLineAccent: "somewhere",
  heroLineThree: "on Earth.",
  productPromise: "Discover the moment.",
  ...
  focusLegend: "Where to next?",
  focusSurprise: "Surprise me",
  focusSunrise: "Morning light",
  focusSunset: "Evening light",
  focusNight: "Night side",
  travel: "Find a moment",
  travelSunrise: "Find morning light",
  travelSunset: "Find evening light",
  ...
  privacyInfo: "Privacy",
  sceneInitial: "Atmospheric photograph and current place data",
  sceneTraveling: "Travelling",
  liveWindow: "MOMENT WINDOW",
  photoLiveData: "LIVE DATA",
  photoBoundary: "ATMOSPHERIC PHOTO · NOT LIVE",
  photoKicker: "Atmospheric photograph",
  photoRepresentative: "This photo represents the light, not the selected place.",
  photoBy: "Photo: {author}",
  photoSceneLabel: "Current moment in {place}: {title}. Atmospheric photograph: {photo}.",
  ...
  aboutBody:
    "The app combines a curated place with local time, sun position, weather and a matching atmospheric photograph. The photo represents the light and is never presented as a live image of that place.",
  ...
  aboutPhotos: "The photographs are stored locally in the app and show their source and licence.",
  ...
  sourcePhotos: "Photos: Wikimedia Commons · individual licence shown with each image",
