...
const de = {
  ...
  sessionFirst: "Ein Ort entdeckt · der nächste Klick bleibt neu.",
  sessionProgress: "{places} verschiedene Orte · {landscapes} Landschaften in dieser Reise.",
  journeyTrailLabel: "Letzte Entdeckungen",
  ...
  shareText:
    "Gerade in {place}: {title}\n{detail}\nOrtszeit: {time}\nEntdeckt mit „Irgendwo ist gerade …“",
  timeSuffix: " Uhr",
...
const en: Record<MessageKey, string> = {
  ...
  sessionFirst: "One place discovered · the next click stays fresh.",
  sessionProgress: "{places} different places · {landscapes} landscapes on this journey.",
  journeyTrailLabel: "Recent discoveries",
  ...
  shareText:
    "Right now in {place}: {title}\n{detail}\nLocal time: {time}\nDiscovered with “Somewhere, right now …”",
  timeSuffix: "",
